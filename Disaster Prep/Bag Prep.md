...
- [ ] Water (2 bottles)
- [ ] Food (kashk, khorma, nuts), protein bars
...
- [ ] powerbank
- [ ] ID docs (photo id, passport, drivers license)
...
- [ ] Food (canned goods: fruits, veggies, meats)
- [ ] Energy / Granola bars
- [ ] Dried fruits, nuts, kashk, khorma
- [ ] peanut butter
- [ ] crackers
- [ ] oatmeal
- [ ] candy / comfort food items
...
- [ ] hydrogen peroxide
- [ ] burn cream
- [ ] pain relievers, anti diarrhea, antacids, antihistamines
- [ ] tweezers
- [ ] scissors
- [ ] medications
- [ ] toilet paper
